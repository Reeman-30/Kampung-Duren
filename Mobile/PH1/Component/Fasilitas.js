...
const Fasilitas = () => {
  const imageList1 = [
    { id: 1, source: require('../assets/livingroom_2992259.png'), description: 'Ruang Tamu', additionalText: '.' },
    { id: 2, source: require('../assets/Group.png'), description: 'Kamar mandi', additionalText: '.' },
    { id: 3, source: require('../assets/dapur.png'), description: 'Dapur', additionalText: '.' },
